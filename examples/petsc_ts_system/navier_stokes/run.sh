...
# simple solve
mpirun -np 2 ./ns-$METHOD -ts_type beuler -ts_monitor -ts_adjoint_monitor -snes_monitor -ksp_type preonly -pc_type lu -pc_factor_mat_solver_package mumps -viewer_binary_skip_info
